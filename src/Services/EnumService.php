...
/**
 * The `EnumService` class is a service proxy (facade) for the `BackedEnumService` and `HasAttributesService` classes.
 *
 ...
 * @method array descriptions(string $enum, ?string $keyBy = null) Retrieve the description attribute for all cases.
 * @method int|string|null id(object $case) Retrieve the id attribute.
 * @method array ids(string $enum, ?string $keyBy = null) Retrieve the id attribute for all cases.
 * @method string|null label(object $case) Retrieve the label attribute.
 * @method array labels(string $enum, ?string $keyBy = null) Retrieve the label attribute for all cases.
 * @method mixed metadata(object $case, string|array|null $key = null) Retrieve the metadata attribute or specific metadata values by key(s).
 * @method array metadatum(string $enum, string|array|null $key = null, ?string $keyBy = null) Retrieve the metadata attribute for all cases, optionally filtered by metadata key(s).
